...
module mojo_top_0 (
  ...
  wire [4-1:0] M_adc_channel;
  wire [8-1:0] M_adc_leds;
  reg [10-1:0] M_adc_sample;
  reg [4-1:0] M_adc_sample_channel;
  reg [1-1:0] M_adc_new_sample;
  adc_to_leds_3 adc (
    .clk(clk),
    .rst(rst),
    .sample(M_adc_sample),
    .sample_channel(M_adc_sample_channel),
    .new_sample(M_adc_new_sample),
    .channel(M_adc_channel),
    .leds(M_adc_leds)
  );
  ...
  always @* begin
    ...
    M_avr_channel = M_adc_channel;
    M_adc_sample = M_avr_sample;
    M_adc_sample_channel = M_avr_sample_channel;
    M_adc_new_sample = M_avr_new_sample;
    led = M_adc_leds;
  end
endmodule

...
module mojo_top_0 (
  ...
  reg [25:0] M_count_d, M_count_q = 1'h0;
  ...
  always @* begin
    ...
    case (M_state_q)
      ...
      STATE000_state: begin
        ...
        pin_b = 1'h0;
        pin_c = 1'h0;
        if (carry == 1'h0 && sum == 1'h0 && M_count_q == 26'h3ffffff) begin
      ...
      STATE001_state: begin
        ...
        pin_b = 1'h0;
        pin_c = 1'h1;
        if (carry == 1'h0 && sum == 1'h1 && M_count_q == 26'h3ffffff) begin
      ...
      STATE011_state: begin
        ...
        pin_b = 1'h1;
        pin_c = 1'h1;
        if (carry == 1'h1 && sum == 1'h0 && M_count_q == 26'h3ffffff) begin
      ...
      STATE111_state: begin
        ...
        pin_b = 1'h1;
        pin_c = 1'h1;
        if (carry == 1'h1 && sum == 1'h1 && M_count_q == 26'h3ffffff) begin
